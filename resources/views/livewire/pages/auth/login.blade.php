        ...
        <div class="space-y-1" x-data="{ show: false }">
            ...
            <div class="relative">
                ...
                <input wire:model="form.password" id="password" :type="show ? 'text' : 'password'" name="password" required autocomplete="current-password"
                    class="block w-full pl-11 pr-12 py-3 bg-gray-50 dark:bg-gray-700/50 border-transparent focus:border-indigo-500 focus:bg-white dark:focus:bg-gray-700 focus:ring-4 focus:ring-indigo-500/10 rounded-2xl transition-all duration-300 dark:text-white"
                    placeholder="••••••••">
                <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-indigo-500 transition-colors">
