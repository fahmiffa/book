                    ...
                    <div class="p-6 sm:p-8 bg-gray-50/50 dark:bg-gray-900/30 flex flex-col sm:flex-row gap-4 shrink-0">
                        ...
                        <div class="order-1 sm:order-2 flex-2 flex gap-2 sm:gap-3 w-full sm:w-auto">
                            ...
                            >
                                ...
                                <div wire:loading wire:target="panggilAction" class="flex items-center justify-center gap-2 w-full">
                                    <svg class="animate-spin h-4 w-4 text-indigo-600 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
                                    <span class="whitespace-nowrap font-black uppercase text-[10px] tracking-widest text-indigo-600">Memanggil...</span>
                                </div>
                            </button>
                            <button 
                                @click="Swal.fire({
                            ...
                            >
                                ...
                                <div wire:loading wire:target="selesaiAction" class="flex items-center justify-center gap-2 w-full">
                                    <svg class="animate-spin h-4 w-4 text-white shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
                                    <span class="whitespace-nowrap font-black uppercase text-[10px] tracking-widest">Proses...</span>
                                </div>
                            </button>
                            </button>
                        </div>
